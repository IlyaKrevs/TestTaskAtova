...
import classes from './FiveSection.module.css';

import TwiceColourText from '../TwiceColourText/TwiceColourText';


import StudentCardItem from './StudentsCardItem/StudentCardItem';
...
export default function FivethSection() {
    ...
    for (let i = 0; i < 13; i++) {
        myTempArr.push(<StudentCardItem />)
    }

    return (
        <div className={classes.fivethSection}>
            ...
            <div className={classes.studentsContainer}>
                ...
                <Carousel children={myTempArr} arrowType='special' gap='0' />
